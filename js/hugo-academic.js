...
(function($){
  ...
  $('.pub-filters').on( 'change', function() {
    ...
    // If filtering by publications type, update the URL hash to enable direct linking to results.
  ...
  * --------------------------------------------------------------------------- */
  ...
  $(window).on('load', function() {
    ...
    $('.projects-container').each(function(index, container) {
      ...
      $container.imagesLoaded(function() {
        ...
        $container.isotope({
          itemSelector: '.isotope-item',
          layoutMode: layout,
          filter: $section.find('.default-projects-filter').text()
        });

        // Filter items when filter link is clicked.
        $section.find('.projects-filters a').click(function() {
        ...
        // Note: If there are multiple projects widgets on a page, ideally only perform this once after images
        // from *all* projects widgets have finished loading.
        if (window.location.hash) {
          scrollToAnchor();
        }
      });
    ...
    // Enable publications filter for publications index page.
